...
3. **[City Weather Identifier v3](https://github.com/saifkayyali3/CityWeatherIdentifier-v3)** - Full-Stack: Responsive web app with Flask backend and Pandas data processing.
...
- Interactive GUI: Built with `tkinter`, featuring a dynamic `OptionMenu` that updates the visualization type based on user preference.
...
```bash
git clone https://github.com/saifkayyali3/City-Weather-Identifier-v2.git
